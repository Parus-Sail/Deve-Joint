...
urlpatterns = [
    ...
    # ============================================= MEMBERS ==================================================
    path('application/', views.MakeAppicationView.as_view(), name='application'),
    path('accept/', views.AcceptAppicationView.as_view(), name='accept'),
    path('reject/', views.RejectApplicationView.as_view(), name='reject'),
    path('exclude/', views.ExcludeMemberView.as_view(), name='exclude'),
    path('leave/', views.LeaveProjectView.as_view(), name='leave'),
]
