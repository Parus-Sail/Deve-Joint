...
urlpatterns = [
    ...
    path('<int:project_id>/members/<int:owner_id>/accept', views.AcceptMemberView.as_view(), name='accept'),
    path('<int:project_id>/members/<int:owner_id>/reject', views.RejectMemberView.as_view(), name='reject'),
]
